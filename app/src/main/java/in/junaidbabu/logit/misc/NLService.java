package in.junaidbabu.logit.misc;
...
import in.junaidbabu.logit.MySQLiteHelper;
import in.junaidbabu.logit.dataClass;

/**
 * Created by jun on 23/9/14.
 */
            ...
            public void run() {
                ...
                new MyLocation().getLocation(getApplicationContext(), new MyLocation.LocationResult() {
                    ...
                    public void gotLocation(Location location) {
                        ...
                        db.addEntry(new dataClass(new Date().toString(), new Date().toString(), "Notif", latlong, sbn.getNotification().tickerText + " via " + sbn.getPackageName(), json.toString(), Time));
//
